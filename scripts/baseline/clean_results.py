...
def main():
    ...
    RES_DIR = "/Users/christianjohansen/Desktop/speciale/results/baseline"
    RES_FILE = os.path.join(RES_DIR, "baseline_98neg_98pos.out")
    OUT_FILE = os.path.join(RES_DIR, "baseline_98neg_98pos.csv")
