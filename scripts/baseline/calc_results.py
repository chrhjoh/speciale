...
def main():
    ...
    res_files = [os.path.join(RES_DIR, "baseline_85neg_90pos.csv"),
                 os.path.join(RES_DIR, "baseline_90neg_90pos.csv"),
                 os.path.join(RES_DIR, "baseline_90neg_95pos.csv"),
                 os.path.join(RES_DIR, "baseline_95neg_95pos.csv"),
                 os.path.join(RES_DIR, "baseline_98neg_98pos.csv")]
    labels = ["0.85, 0.90",
              "0.9",
              "0.9, 0.95",
              "0.95",
