...
def main():
    ...
    alpha_igblast_file = os.path.join(DIR, "data/igblast/alpha_igblast.txt")
    beta_igblast_file = os.path.join(DIR, "data/igblast/beta_igblast.txt")
    alpha_seq_file = os.path.join(DIR, "data/fasta/alpha_chains.fa")
    beta_seq_file = os.path.join(DIR, "data/fasta/alpha_chains.fa")
    ...
    write_cdrs(alpha_cdrs, os.path.join(DIR, "data/fasta/alpha_cdrs.fa"))
    write_cdrs(beta_cdrs, os.path.join(DIR, "datafasta/beta_cdrs.fa"))
